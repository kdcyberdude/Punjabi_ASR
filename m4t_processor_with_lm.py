...
from transformers.utils import ModelOutput, logging, requires_backends
...
class M4TProcessorWithLM(ProcessorMixin):
    r"""
    Constructs a M4Tprocessor which wraps a Wav2Vec2 feature extractor, a Wav2Vec2 CTC tokenizer and a decoder
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, **kwargs):
        ...
        This class method is simply calling SeamlessM4TFeatureExtractor's
    ...
    def __call__(self, *args, **kwargs):
        """
        When used in normal mode, this method forwards all its arguments to 's
        [`~SeamlessM4TFeatureExtractor.__call__`] and returns its output. If used in the context
        [`~M4TProcessorWithLM.as_target_processor`] this method forwards all its arguments to
    ...
    def batch_decode(
        self,
        logits: np.ndarray,
        pool: Optional[Pool] = None, # type: ignore
