...
def load_vad_model(device, vad_onset=0.500, vad_offset=0.363, use_auth_token=None, model_fp=None):
    vad_model = Model.from_pretrained(model_fp, use_auth_token=use_auth_token, batch_size= 32,)
    hyperparameters = {
                    "min_duration_on": 0.1,
                    "min_duration_off": 0.1,
                    }
    vad_pipeline = VoiceActivitySegmentation(segmentation=vad_model, device=torch.device(device), batch_size=32,)
